...
extern "C" {
    pub fn cef_display_get_count() -> size_t;
}
extern "C" {
    pub fn cef_display_get_alls(displaysCount: *mut size_t, displays: *mut *mut cef_display_t);
}
#[repr(C)]
#[derive(Debug, Default, Copy, Clone)]
...
pub struct _cef_panel_t {
    ...
    pub get_child_view_count:
        ::std::option::Option<unsafe extern "C" fn(self_: *mut _cef_panel_t) -> size_t>,
